...
<form role="search" method="get" class="search-form search-form-header form-inline" action="<?php echo get_template_directory_uri(); ?>/ckan-search.php/?q" data-ckan="<?php echo get_template_directory_uri(); ?>/ckan-search.php" data-wordpress="<?php echo home_url('/'); ?>">
